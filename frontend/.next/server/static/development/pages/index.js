...
const DroneStateStyles = styled_components__WEBPACK_IMPORTED_MODULE_5___default.a.div.withConfig({
...
const CameraStyles = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "camera__CameraStyles",
  componentId: "sc-1l0san4-0"
})(["width:100%;"]);
debugger;

const Camera = props => __jsx(CameraStyles, {
  level: props.battery,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 10
...
const SpeedStyles = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "flightdata__SpeedStyles",
  componentId: "sc-178rp3v-0"
})(["width:100%;"]);

const FlightData = props => __jsx(SpeedStyles, {
  speed: props.speed,
  __source: {
    fileName: _jsxFileName,
    lineNumber: 7
...
module.exports = __webpack_require__(/*! F:\VSONLINE\Drone\frontend\pages\index.js */"./pages/index.js");
